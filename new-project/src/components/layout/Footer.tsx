...
const socialLinks = [
  { name: 'Twitter', href: 'https://x.com/plabiq', icon: Twitter },
  { name: 'LinkedIn', href: 'https://www.linkedin.com/company/plabiq', icon: Linkedin },
  { name: 'Instagram', href: 'https://www.instagram.com/plabiq/', icon: Instagram },
]
  ...
  return (
    <footer className="bg-gray-900 dark:bg-slate-950 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        {/* Bottom Section */}
        <div className="border-t border-gray-800 dark:border-slate-800 mt-12 pt-8">
